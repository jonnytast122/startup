...
export default function PaySummary() {
	...
	return (
		<div className="bg-gray-100 md:bg-white min-h-screen rounded-md font-custom">
						...
						<table className="w-full text-sm">
							<thead>
								<tr className="bg-gray-200">
									<th className="w-1/3 px-3 py-2 text-center font-medium">
										Working Days
									</th>
									<th className="w-1/3 px-3 py-2 text-center font-medium">
										Gross Salary
						...
						<table className="w-full">
							<thead>
								<tr className="bg-gray-200">
									...
									<th className="w-1/5 min-w-[160px] px-4 py-3 text-center font-medium">
										Total Working Day
									</th>
									<th className="w-1/5 min-w-[140px] px-4 py-3 text-center font-medium">
										Total Gross Salary
									</th>
									<th className="w-1/5 min-w-[120px] px-4 py-3 text-center font-medium">
										Tax
									</th>
									<th className="w-1/5 min-w-[120px] px-4 py-3 text-center font-medium">
										NSSF
	...
	return (
		<div className="border-0 shadow-none rounded-2xl bg-white">
			<div className="py-4 text-center">
				...
				<div className={`mt-1 text-lg sm:text-xl font-semibold ${valueClass}`}>
					{value}
				</div>
			</div>
		</div>
	...
	return (
		<>
			...
			<tr className="hover:bg-gray-100 text-center border-b">
				...
				<td className={`py-3 ${isBlank ? "" : "text-red-500"}`}>
					{isBlank ? "---" : tax}
				</td>
				<td className={`py-3 ${isBlank ? "" : "text-red-500"}`}>
					{isBlank ? "---" : nssf}
...
function MobileMonthBlock({ month, workingDay, gross, tax, nssf, total }) {
	...
	return (
		<>
			...
			<tr className="text-center rounded-t-xl">

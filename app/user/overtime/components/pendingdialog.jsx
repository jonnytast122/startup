  ...
  return (
    <>
      ...
      <Drawer direction="right" open={open} onOpenChange={setOpen}>
        ...
        {/* Drawer */}
        <DrawerContent
          className="fixed top-0 bottom-0 right-0 left-auto
             z-50 w-[420px] md:w-[480px]
             bg-transparent p-0 border-none"
        >
          <div className="h-screen bg-gray-100 flex flex-col border-l">
            {/* Header */}
      ...
      <Dialog open={confirmDialog} onOpenChange={setConfirmDialog}>
        <DialogContent className="bg-gray-100 w-[400px] text-center">
          ...
          <Input placeholder="Add note" className="mt-4" />
          <Button className="mt-4" onClick={() => setConfirmDialog(false)}>
            Confirm
          </Button>
        </DialogContent>
      </Dialog>

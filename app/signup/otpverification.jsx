          ...
          <CardContent className="p-14 md:p-16 flex flex-col justify-center relative">
            ...
            <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
              <div className="flex flex-col gap-6 items-center">
                ...
                {/* OTP Input */}
                <div className="flex gap-2 sm:gap-3 md:gap-4 lg:gap-5 justify-center mt-4">
                  {otp.map((digit, index) => (
                    <input
                      key={index}
                      type="text"
                      ...
                      maxLength="1"
                      className="text-center border-b-2 border-gray-300 focus:outline-none text-blue
        w-10 h-10 text-xl 
        sm:w-12 sm:h-12 sm:text-2xl 
        md:w-14 md:h-14 md:text-3xl 
        lg:w-16 lg:h-16 lg:text-4xl"
                    />
                  ))}
                </div>
                {/* OTP Expiration Text */}

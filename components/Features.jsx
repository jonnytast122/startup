...
function FeaturesComparison() {
  ...
  const schedule = [
    ...
    {
      name: "In Shift Status Tracking",
      availability: ["Comprehensive Tracking with automation", "Unlimited"],
    },
    {
      name: "Dedicated In Shifts Tasks",
    ...
    {
      name: "Decide if Users Can See Each Other’s Schedules",
  ...
  const time_clock = [
    ...
    {
      name: "In Shift Status Tracking",
      availability: ["Available with live tracking + history", "Single"],
    },
    {
      name: "Dedicated In Shifts Tasks",
      availability: ["Unlimited", "Unlimited"],
  ...
  return (
    <div id="feature" className="max-container mx-auto px-6 py-10">
      ...
      <div className="flex flex-col md:flex-row lg:flex-row justify-center items-start">
        {/* First Table Card */}
        <div className="mt-10 rounded-xl shadow-xl mx-2 border-2 border-gray p-4">
